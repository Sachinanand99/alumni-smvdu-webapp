'use client'
// todo: update this for creating the events
...
const StartupForm = () => {
  ...
  return (
     <form action={(formAction)} className="startup-form">
       <div>
         <label htmlFor="title" className="event-form_label">Title</label>
         <Input id="title" name="title" className="event-form_input" required placeholder="Event Title" />
